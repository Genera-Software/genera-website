  ...
  return (
    <form action={formAction} className="flex flex-col gap-4">
      ...
      <button
        type="submit"
        disabled={pending}
        className="w-full rounded-lg bg-gold px-4 py-3 text-center text-base font-semibold text-forest-dark transition hover:bg-gold-soft disabled:opacity-60"
      >
