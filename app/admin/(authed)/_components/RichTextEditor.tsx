  ...
  return (
    <div className="rounded-lg border border-teal-mid bg-white">
      ...
      <style>{`
        ...
        .prose-editor h2 { font-family: var(--font-massilia, inherit); font-size: 1.5rem; font-weight: 700; margin: 1.4em 0 0.5em; color: #0f172a; }
        .prose-editor h3 { font-family: var(--font-massilia, inherit); font-size: 1.2rem; font-weight: 700; margin: 1.2em 0 0.4em; color: #0f172a; }
