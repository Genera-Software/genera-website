  ...
  return (
    <div className="relative mx-auto flex w-full max-w-[580px] flex-col items-center">
      ...
      <div className="relative">
        ...
        <div
          aria-hidden
          className="showcase-float absolute top-[16%] -left-[122px] -rotate-6 animate-[var(--animate-illust-float)]"
        >
        ...
        <div
          aria-hidden
          className="showcase-float absolute -right-[150px] bottom-[21%] rotate-3 animate-[var(--animate-illust-float)] [animation-delay:1.4s]"
        >
...
function Phone({ brand }: { brand: Brand }) {
  return (
    <DeviceFrame label={`The ${brand.name} owner app on a phone: a booking calendar for September, a confirmed daycare day for Milo, and a bottom menu in the daycare's brand colour.`}>
